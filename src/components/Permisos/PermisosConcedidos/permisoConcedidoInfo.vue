...
<template>
  <div class="container">    
    <div class="row q-pb-sm">
        ...
        <q-input class="col-9"  v-model="permiso.ejercicio" label="Ejercicio" stack-label dense readonly/>
    </div>
    <div class="row q-pb-sm">
    ...
    <div class="row q-pb-sm">
        <q-input class="col-5 q-pr-sm"  v-model="permiso.numJornadas" label="Num. Jornadas" stack-label dense readonly/>
        <q-input class="col-7"  v-model="permiso.tipoJornadaLibre" label="Tipo Jornada Libre" stack-label dense readonly/>
    </div>
    <div class="row q-pb-sm">
        <q-input class="col"  v-model="permiso.observaciones" label="Observaciones" stack-label dense readonly/>
    </div>
    <div class="row q-pb-sm">
        <q-input class="col"  v-model="permiso.sustituto" label="Sustituto" stack-label dense readonly/>
    </div>
    <div class="row q-pb-sm">
    ...
    <div class="row q-pb-sm">
        <q-input class="col-4 q-pr-sm" v-model="permiso.justValid" label="Just. Valid" stack-label dense readonly/>
        <q-input class="col-4 q-pr-sm" v-model="permiso.justNoValid" label="Just. No Valid" stack-label dense readonly/>
        <q-input class="col-4" v-model="permiso.autSinDoc" label="Aut. Sin Doc" stack-label dense readonly/>
    </div>
    <div class="row q-pb-sm">
