...
import personalFilter from 'components/ConsultaReservas/consReservasFilter.vue'
import personalGrid from 'components/ConsultaReservas/consReservasGrid.vue'
...
export default {
  ...
  mounted () {
    if (this.value.filterRecord) { // si ya hemos cargado previamente los recargo al volver a este tab
      ...
      this.filterRecord = { codEmpresa: this.user.codEmpresa, idpersonal: this.user.pers.idpersonal, fechaDesde: date.formatDate(new Date(), 'YYYY-MM-DD') }
